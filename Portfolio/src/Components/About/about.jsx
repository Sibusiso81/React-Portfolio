    ...
    <section className='h-screen  lg:h-screen w-fit bg-neutral-950 flex flex-col justify-center'>
        <div className='grid grid-cols-2 gap-12 md:gap-2  mt-4 p-2 '>
            ...
            <div className='col-span-2 md:col-span-1 text-white flex flex-col font-poppins lg:text-[16px] md:mt-6 pr-1 lg:pr-10 justif-center'>
                ...
                An aspiring Human Resources practitioner who has in persuit of this status found himself again taking to task the opportunity to equipt himself with Web devlopment knowledge as it to some expent revelutionised the field and moulding that knowledge into an ability to build responsive web aplications with <span className='text-gray-700'>invaluable functionalities and accesible user interfaces</span> using various technologies
