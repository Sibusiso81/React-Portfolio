    ...
    <section className='h-screen  lg:h-screen w-fitt bg-neutral-950 flex flex-col justify-center '>
        <div className='grid grid-cols-2 gap-12 md:gap-2  mt-4 p-2 '>
            ...
            <div className='flex flex-row  mt-2 p-1 md:p-6'>
                ...
                <div className=' rounded-full overflow-hidden h-fit w-fit text-wrap j
                 '>
                    <img
                 ...
                 <div className='flex flex-col text-white text-md font-poppins  text-sm mx-auto  col-span-2 '>
                    <p>Sibusiso Zulu</p>
                    <p>HRM Student   & <br />
